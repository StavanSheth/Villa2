...
async function main() {
  ...
  const getSnapshots = (config: number) => {
    switch (config) {
      ...
      case 32: return {
        snapshotStaySegments: [{ checkIn: '2026-08-20', checkOut: '2026-08-21' }, { checkIn: '2026-08-28', checkOut: '2026-08-29' }],
        snapshotGuests: { '2026-08-20': { adults: 4, children: 2 }, '2026-08-28': { adults: 6, children: 2 } }, // Assuming guests remain for both but service changed
        snapshotServices: { '2026-08-20': ['Breakfast ×1', 'BBQ ×2', 'Decoration ×1'], '2026-08-28': ['Breakfast ×1', 'BBQ ×2', 'Decoration ×2'] } 
      };
      case 33: return {
        snapshotStaySegments: [{ checkIn: '2026-08-20', checkOut: '2026-08-21' }, { checkIn: '2026-08-28', checkOut: '2026-08-29' }],
        snapshotGuests: { '2026-08-20': { adults: 4, children: 2 }, '2026-08-28': { adults: 6, children: 2 } },
        snapshotServices: { '2026-08-28': ['Breakfast ×1', 'BBQ ×2', 'Decoration ×2'] } 
      };
      case 41: return {
  ...
  const b1 = await prisma.booking.create({
    data: {
      ...baseBooking,
      bookingCode: 'SCENARIO-1',
      currentTotal: 87500,
      totalAdvancePaid: 45000,
      totalPaid: 45000,
      amountToBePaid: 42500,
      orderTransactions: {
        create: [
          {
            srNo: 1, transactionTime: new Date('2026-08-11T15:25:00Z'),
            actionType: 'CREATE', actorRole: 'CUSTOMER', previousState: 'NEW', newState: 'CONFIRMED',
          ...
          },
          {
            ...
            actionType: 'EDIT', actorRole: 'CUSTOMER', previousState: 'CONFIRMED', newState: 'CONFIRMED',
          ...
          },
          {
            ...
            actionType: 'PAYMENT', actorRole: 'CUSTOMER', previousState: 'CONFIRMED', newState: 'CONFIRMED',
            paymentType: 'ADVANCE', refundTier: 'N/A', refundStatus: 'N/A',
  ...
  const b2 = await prisma.booking.create({
    data: {
      ...baseBooking,
      bookingCode: 'SCENARIO-2',
      status: 'ADVANCE_PAID',
      currentTotal: 50000,
      totalAdvancePaid: 50000,
      totalPaid: 50000,
      totalRefunded: 10000,
      amountToBePaid: 0,
      orderTransactions: {
        create: [
          ...
          },
          {
            ...
            actionType: 'EDIT', actorRole: 'CUSTOMER', previousState: 'ADVANCE_PAID', newState: 'ADVANCE_PAID',
  ...
  const b3 = await prisma.booking.create({
    data: {
      ...baseBooking,
      bookingCode: 'SCENARIO-3',
      status: 'PARTIALLY_CANCELLED',
      currentTotal: 60000,
      totalAdvancePaid: 30000,
      totalPaid: 30000,
      totalRefunded: 20000,
      ...
      orderTransactions: {
        create: [
          ...
          },
          {
            ...
            actionType: 'CANCEL', actorRole: 'CUSTOMER', previousState: 'CONFIRMED', newState: 'CANCELLED',
  ...
  const b5 = await prisma.booking.create({
    data: {
      ...baseBooking,
      bookingCode: 'SCENARIO-5',
      status: 'CANCELLED',
      currentTotal: 85000,
      totalAdvancePaid: 30000,
      totalPaid: 30000,
      totalRefunded: 0,
      amountToBePaid: 55000,
      orderTransactions: {
        create: [
          {
          ...
          },
          {
            ...
            actionType: 'CANCEL_CONFIRMED', actorRole: 'OWNER', previousState: 'CANCELLED', newState: 'CANCELLED',
            paymentType: 'ADVANCE', refundTier: '<7 Days', refundStatus: 'NO_REFUND',
            previousOrderTotal: 85000, orderValueDelta: 0, newOrderTotal: 85000,
            previousTotalPaid: 30000, advancePaymentDelta: 0, balancePaymentDelta: 0, refundDueDelta: 0, refundPaidDelta: 0,
            newTotalPaid: 30000, newTotalRefunded: 0, newAdvancePaid: 30000, newRemainingAmount: 55000, newPendingRefund: 0, newAmountToBePaid: 55000,
  ...
  const b6 = await prisma.booking.create({
    data: {
      ...baseBooking,
      bookingCode: 'SCENARIO-6',
      status: 'ADVANCE_PAID',
      currentTotal: 90000,
      totalAdvancePaid: 60000,
      totalPaid: 60000,
      totalRefunded: 10000,
      ...
      orderTransactions: {
        create: [
          ...
          },
          {
            ...
            actionType: 'EDIT', actorRole: 'CUSTOMER', previousState: 'REFUNDED', newState: 'ADVANCE_PAID',
            paymentType: 'ADVANCE', refundTier: 'N/A', refundStatus: 'N/A',
  ...
  const b7 = await prisma.booking.create({
    data: {
      ...baseBooking,
      bookingCode: 'SCENARIO-7',
      status: 'REFUNDED',
      currentTotal: 92000,
      totalAdvancePaid: 50000,
      totalPaid: 50000,
      totalRefunded: 15000,
      amountToBePaid: 27000,
      orderTransactions: {
        create: [
          {
          ...
          },
          {
            ...
            actionType: 'EDIT', actorRole: 'CUSTOMER', previousState: 'ADVANCE_PAID', newState: 'ADVANCE_PAID',
            paymentType: 'ADVANCE', refundTier: 'N/A', refundStatus: 'NO_REFUND',
            previousOrderTotal: 110000, orderValueDelta: 12000, newOrderTotal: 122000, // Delta is 12000
          ...
          },
          {
            ...
            actionType: 'PAYMENT', actorRole: 'CUSTOMER', previousState: 'ADVANCE_PAID', newState: 'ADVANCE_PAID',
          ...
          },
          {
            ...
            ...getSnapshots(71) // Removing Aug 24
          },
          {

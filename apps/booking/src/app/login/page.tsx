  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0d1117] text-white p-4">
      <div className="max-w-md w-full bg-white/5 border border-white/10 rounded-xl p-8 backdrop-blur-md">
        <h2 className="text-3xl font-serif text-[#D4AF37] mb-2 text-center">Guest Portal</h2>
        <p className="text-sm text-white/60 text-center mb-8">Sign in to manage your villa bookings and stays</p>

        <form onSubmit={(e) => { e.preventDefault(); handleDemoLogin('demo-guest-jwt'); }} className="space-y-4">
          <div>
            <label className="block text-xs text-white/70 uppercase font-semibold mb-1">Email</label>
            <input 
              type="email" 
              defaultValue="guest@mavon.online" 
        ...
        <div className="mt-6 pt-6 border-t border-white/10 text-center">
          ...
          <div className="flex gap-2 justify-center">
            <button 
              onClick={() => handleDemoLogin('demo-guest-jwt')}

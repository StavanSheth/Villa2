  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground p-4">
      <div className="max-w-md w-full bg-card border border-border rounded-xl p-8 backdrop-blur-md">
        <h2 className="text-3xl font-serif text-primary mb-2 text-center">Booking Portal</h2>
        <p className="text-sm text-muted-foreground text-center mb-4">Sign in to book your luxury stay</p>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input 
              ...
              placeholder="guest@mavon.online"
              required

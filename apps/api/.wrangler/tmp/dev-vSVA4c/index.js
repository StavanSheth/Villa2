...
// .wrangler/tmp/bundle-jC5Vgd/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-jC5Vgd/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-jC5Vgd/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var BookingsRepository = class {
   ...
   */
  static async hasOverlappingBookings(villaId, checkIn, checkOut, excludeBookingId) {
...
var RefundPolicyRepository = class {
   ...
   */
  static async getActivePolicy(villaId) {
   ...
   */
  static async snapshotForBooking(villaId) {
    const policy = await this.getActivePolicy(villaId);
    if (!policy)
      return null;
    return {
      policyId: policy.id,
...
var BookingEngineService = class {
  ...
  static async createBooking(input) {
    ...
    if (requiresPayment) {
      refundPolicySnapshot = await RefundPolicyRepository.snapshotForBooking(input.villaId);
    }
    ...
    await prisma.bookingEvent.create({
      data: {
        ...
        metadata: {
          ...
          refundPolicyId: refundPolicySnapshot?.policyId || null
        }
      }
    });
    const notifications = [];

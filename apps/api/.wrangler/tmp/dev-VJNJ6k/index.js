...
// .wrangler/tmp/bundle-ZDIhUd/strip-cf-connecting-ip-header.js
...
In case this error is unexpected for you, please report it in https://pris.ly/prisma-prisma-bug-report`
    ...
    exports.Prisma.StaySegmentScalarFieldEnum = {
      id: "id",
      bookingId: "bookingId",
      checkIn: "checkIn",
      checkOut: "checkOut",
    ...
    exports.Prisma.ServiceDefScalarFieldEnum = {
      id: "id",
      name: "name",
      description: "description",
      category: "category",
    ...
    exports.Prisma.OrderTransactionScalarFieldEnum = {
      ...
      snapshotStaySegments: "snapshotStaySegments",
      snapshotServices: "snapshotServices",
      snapshotGuests: "snapshotGuests",
      transactionId: "transactionId"
    };
    exports.Prisma.ReservationLockScalarFieldEnum = {
      id: "id",
      villaId: "villaId",
    ...
    exports.Prisma.RefundPolicyScalarFieldEnum = {
      ...
      refundGatewayFee: "refundGatewayFee",
      refundGst: "refundGst",
    ...
    exports.Prisma.RefundSlabScalarFieldEnum = {
      id: "id",
      refundPolicyId: "refundPolicyId",
      minHoursBefore: "minHoursBefore",
      maxHoursBefore: "maxHoursBefore",
      refundPercent: "refundPercent"
    };
    exports.Prisma.VillaBookingSettingsScalarFieldEnum = {
      id: "id",
      villaId: "villaId",
      allowOfflineBooking: "allowOfflineBooking",
      allowMaintenanceBlock: "allowMaintenanceBlock",
      allowPrivateGuest: "allowPrivateGuest",
      allowVipBooking: "allowVipBooking",
    ...
    exports.Prisma.GuestIdProofScalarFieldEnum = {
      id: "id",
      bookingId: "bookingId",
      guestName: "guestName",
      fileUrl: "fileUrl",
    ...
    exports.Prisma.ModelName = {
      ...
      RefundSlab: "RefundSlab",
      VillaBookingSettings: "VillaBookingSettings",
...
// .wrangler/tmp/bundle-ZDIhUd/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-ZDIhUd/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// ../../node_modules/.pnpm/hono@4.13.0/node_modules/hono/dist/middleware/body-limit/index.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var rateLimiter = /* @__PURE__ */ __name((options) => {
  return async (c, next) => {
    ...
    if (record.count > options.max) {
      c.header("Retry-After", Math.ceil((record.resetAt - now) / 1e3).toString());
...
// ../../packages/database/queries/financial-engine.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// ../../packages/database/utils/ledger-math.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// ../../packages/database/queries/ledger.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
async function verifyFirebaseToken(idToken) {
  try {
    ...
    if (user.isLocked || user.lockedUntil && /* @__PURE__ */ new Date() < user.lockedUntil) {
  ...
  try {
    ...
    const intent = await prisma.$transaction(async (tx) => {
      ...
      if (booking.status !== "AWAITING_PAYMENT")
        throw new Error("Booking not awaiting payment");
      const orderId = `order_${crypto_default.randomUUID().substring(0, 10)}`;
      ...
      return orderId;
    }, { isolationLevel: "Serializable", timeout: 1e4 });
    return c.json({ orderId: intent });
  } catch (error3) {
    if (error3.code === "P2034" || error3.code === "P2002") {
...
payments.post("/webhook", async (c) => {
  try {
    ...
    let cached = "OK";
    if (!process.env.UPSTASH_REDIS_REST_URL?.includes("placeholder")) {
      try {
    ...
    if (event.event === "payment.captured" || event.event === "order.paid") {
      ...
      const booking = await prisma.booking.findFirst({
        where: { id: receiptId }
        // receipt mapped to our booking id
      });
      if (booking) {
        ...
        await prisma.$transaction(async (tx) => {
          ...
          timeout: 1e4
          // Category 3: Database Resilience - Transaction Timeout
        });
...
invoices.post("/", async (c) => {
  try {
    ...
    while (retries > 0) {
      try {
        invoice = await prisma.$transaction(async (tx) => {
          ...
          const invoiceNo = `INV-${(/* @__PURE__ */ new Date()).getFullYear()}-${Math.floor(1e3 + Math.random() * 9e3)}`;
          const newInvoice = await tx.invoice.create({
            data: {
              ...
              taxAmount: Number(booking.currentTotal) * 0.18,
              // 18% GST example
    ...
    console.error("Invoice generation failed:", error3);
    return c.json({ error: error3.message }, 500);
  }
});
...
reviews.post("/", async (c) => {
  try {
    ...
    console.error("Review submission failed:", error3);
    return c.json({ error: error3.message }, 403);
  }
});
var reviews_default = reviews;

// src/routes/booking-engine.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var BookingsRepository = class {
   ...
   */
  static async hasOverlappingBookings(villaId, checkIn, checkOut, excludeBookingId, tx = prisma) {
    const count3 = await tx.booking.count({
      where: {
        villaId,
        status: {
   ...
   */
  static async findBookingByIdOrCode(idOrCode) {
...
__name(BookingsRepository, "BookingsRepository");
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var RefundPolicyRepository = class {
  /**
   * Get the active refund policy for a villa (with slabs).
   */
  static async getActivePolicy(villaId, tx = prisma) {
  ...
  static async createPolicy(data) {
    ...
    return prisma.refundPolicy.create({
      data: {
        ...
        isActive: true,
        slabs: data.slabs ? { create: data.slabs } : void 0
      },
      include: { slabs: true }
    });
  }
   ...
   */
  static async snapshotForBooking(villaId, tx = prisma) {
...
__name(RefundPolicyRepository, "RefundPolicyRepository");
...
function canTransition(from, to) {
  return TRANSITIONS2[from]?.includes(to) ?? false;
}
__name(canTransition, "canTransition");
function validateTransition2(from, to) {
  if (!canTransition(from, to)) {
    throw new Error(`Invalid booking transition: ${from} \u2192 ${to}`);
  }
  return to;
}
__name(validateTransition2, "validateTransition");
function getInitialStatus(autoConfirm, paymentRequired) {
  if (autoConfirm)
    return "CONFIRMED";
  if (!paymentRequired)
    return "CONFIRMED";
...
__name(getInitialStatus, "getInitialStatus");
function isCancellable(status) {
  return canTransition(status, "CANCELLED");
}
__name(isCancellable, "isCancellable");
...
var RefundEngineService = class {
   ...
   */
  static calculateRefund(snapshot, financials) {
    const now = /* @__PURE__ */ new Date();
    const hoursBeforeCheckIn = Math.max(
      0,
      (financials.checkIn.getTime() - now.getTime()) / (1e3 * 60 * 60)
    );
    ...
    const villaAmount = financials.totalAmount - financials.gstAmount - financials.platformFee - financials.gatewayFee;
   ...
   */
  static findMatchingSlab(slabs, hours) {
...
__name(RefundEngineService, "RefundEngineService");
function round(n) {
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
function shouldNotify(event, bookingType, mode) {
...
// ../../domains/bookings/services/booking-engine.service.ts
var BookingEngineService = class {
  /**
  ...
  static async createBooking(input) {
    ...
    const { booking, refundPolicySnapshot } = await prisma.$transaction(async (tx) => {
      ...
      const requiresPayment2 = input.paymentRequired !== void 0 ? input.paymentRequired : rules.paymentRequired;
      let policySnapshot = null;
      if (requiresPayment2) {
        policySnapshot = await RefundPolicyRepository.snapshotForBooking(input.villaId, tx);
      }
      const initialStatus = getInitialStatus(rules.autoConfirm, requiresPayment2);
      const numNights = Math.round(
        (checkOut.getTime() - checkIn.getTime()) / (1e3 * 60 * 60 * 24)
      );
      const bookingCode = `MVN-${Math.floor(1e5 + Math.random() * 9e5)}`;
      const createdByRole = input.mode === "CUSTOMER" ? "CUSTOMER" : input.mode === "OWNER" ? "OWNER" : "STAFF";
      if (input.promoCode && !rules.promoEnabled) {
        input.promoCode = void 0;
      }
      const newBooking = await tx.booking.create({
        data: {
          ...
          totalAmount: 0,
          // Will be updated by pricing calculation
          paidAmount: 0,
          status: initialStatus,
          paymentType: requiresPayment2 ? input.paymentType || "FULL" : null,
          ...
          createdByRole,
          paymentRequired: requiresPayment2,
          bookingReason: input.bookingReason || null,
          internalNotes: input.internalNotes || null,
          refundPolicySnapshot: policySnapshot,
    ...
    const requiresPayment = input.paymentRequired !== void 0 ? input.paymentRequired : rules.paymentRequired;
    return {
      booking,
      rules,
      requiresPayment,
   ...
   */
  static async transitionStatus(bookingId, newStatus, actorId, actorRole, metadata) {
    ...
    const validatedStatus = validateTransition2(
      booking.status,
      newStatus
    );
    ...
    if (Number(booking.paidAmount) > 0 && booking.refundPolicySnapshot) {
      refundCalc = RefundEngineService.calculateRefund(
        booking.refundPolicySnapshot,
        {
          ...
          gatewayFee: 0,
          // ponytail: gatewayFee not stored on booking yet, use 0
   ...
   */
  static async convertBookingType(bookingId, newType, actorId, actorRole) {
    const booking = await prisma.booking.findUniqueOrThrow({
      where: { id: bookingId },
      include: { villa: true }
    });
   ...
   */
  static async addInternalNotes(bookingId, notes, actorId, actorRole) {
    const booking = await prisma.booking.findUniqueOrThrow({
      where: { id: bookingId },
      include: { villa: true }
    });
...
[${timestamp}] ${actorRole}: ${notes}` : `[${timestamp}] ${actorRole}: ${notes}`;
    return prisma.booking.update({
      where: { id: bookingId },
   ...
   */
  static async assignStaff(bookingId, staffId, caretakerId, actorId, actorRole) {
    const booking = await prisma.booking.findUniqueOrThrow({
      where: { id: bookingId },
      include: { villa: true }
    });
    ...
    const updated = await prisma.booking.update({
      where: { id: bookingId },
      data: {
        ...staffId !== void 0 ? { assignedStaffId: staffId } : {},
        ...caretakerId !== void 0 ? { assignedCaretakerId: caretakerId } : {}
      }
    });
    await prisma.bookingEvent.create({
      data: {
   ...
   */
  static async validateVillaSettings(villaId, bookingType) {
    ...
    for (const [settingKey, guardedTypes] of Object.entries(BOOKING_SETTINGS_GUARDS)) {
      if (guardedTypes.includes(bookingType)) {
        ...
        if (allowed === false) {
          throw new Error(
            `Booking type "${bookingType}" is not allowed for this villa. Setting "${settingKey}" is disabled.`
          );
        }
      }
    }
...
__name(BookingEngineService, "BookingEngineService");
...
// ../../packages/validation/index.ts
var BookingTypeEnum = external_exports.enum([
  "NORMAL",
  "OWNER",
  "VIP",
  "PRIVATE",
...
var BookingSourceEnum = external_exports.enum([
  "CUSTOMER",
  "OWNER",
  "STAFF",
  "WEBSITE",
...
var BookingModeEnum = external_exports.enum(["CUSTOMER", "OWNER", "STAFF"]);
var CheckAvailabilitySchema = external_exports.object({
  villaId: external_exports.string().min(1, "Villa ID is required"),
  checkIn: external_exports.string().datetime({ message: "Invalid check-in date string" }),
  checkOut: external_exports.string().datetime({ message: "Invalid check-out date string" }),
  numGuests: external_exports.number().int().positive().min(1)
});
var CreateBookingSchema = CheckAvailabilitySchema.extend({
  userId: external_exports.string().min(1, "User ID is required"),
  ...
  paymentRequired: external_exports.boolean().default(true),
  bookingReason: external_exports.string().optional(),
  internalNotes: external_exports.string().optional(),
  guestProfileId: external_exports.string().optional(),
  // Payment
  paymentType: external_exports.enum(["FULL", "ADVANCE"]).optional(),
  selectedServices: external_exports.array(external_exports.object({ serviceDefId: external_exports.string() })).optional()
});
var CancelBookingSchema = external_exports.object({
  bookingId: external_exports.string().min(1, "Booking ID is required"),
  reason: external_exports.string().optional()
});
var RefundSlabSchema = external_exports.object({
  minHoursBefore: external_exports.number().int().min(0),
  maxHoursBefore: external_exports.number().int().min(0),
  refundPercent: external_exports.number().min(0).max(100)
});
var CreateRefundPolicySchema = external_exports.object({
  villaId: external_exports.string().min(1),
  name: external_exports.string().min(1).default("Default Policy"),
  refundType: external_exports.enum(["FULL_REFUND", "VILLA_AMOUNT_ONLY", "PERCENTAGE_BASED", "CUSTOM_RULES"]),
  refundGatewayFee: external_exports.boolean().default(true),
  refundGst: external_exports.boolean().default(true),
  refundPlatformFee: external_exports.boolean().default(true),
  slabs: external_exports.array(RefundSlabSchema).optional()
});
var VillaBookingSettingsSchema = external_exports.object({
  villaId: external_exports.string().min(1),
  allowOfflineBooking: external_exports.boolean().default(true),
  allowMaintenanceBlock: external_exports.boolean().default(true),
  allowPrivateGuest: external_exports.boolean().default(true),
  allowVipBooking: external_exports.boolean().default(true),
  requireInvoice: external_exports.boolean().default(false),
  requireCustomerProfile: external_exports.boolean().default(false)
});
var GuestProfileSchema = external_exports.object({
  name: external_exports.string().min(1, "Guest name is required"),
...
bookingEngine.post("/create", async (c) => {
  try {
    ...
    console.error("Booking engine create error:", error3);
    return c.json({ error: error3.message || "Failed to create booking" }, 400);
  }
});
bookingEngine.get("/calendar/:villaId", async (c) => {
  try {
    ...
    const entries = bookings.map((b) => {
      const rules = BOOKING_TYPE_RULES[b.bookingType];
      return {
        bookingId: b.id,
        bookingCode: b.bookingCode,
        checkIn: b.checkIn.toISOString(),
        checkOut: b.checkOut.toISOString(),
        type: rules?.calendarColor || "CUSTOMER",
    ...
    console.error("Calendar fetch error:", error3);
    return c.json({ error: error3.message }, 500);
  }
});
...
var booking_engine_default = bookingEngine;

// src/routes/refund-policy.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var refundPolicy = new Hono2();
...
var refund_policy_default = refundPolicy;
...
// src/cron/expireLocks.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
async function expireReservationLocks() {
  ...
  try {
    ...
    console.error("Error expiring reservation locks:", error3);
  }
}
__name(expireReservationLocks, "expireReservationLocks");
...
// ../../domains/payments/calculations/index.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// ../../domains/payments/razorpay/index.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// ../../domains/payments/webhooks/index.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// ../../domains/bookings/services/cancellation.service.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// ../../domains/bookings/services/locks.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
app.post("/auth/refresh", async (c) => {
  ...
  try {
    ...
    if (session.user.isLocked || session.user.lockedUntil && /* @__PURE__ */ new Date() < session.user.lockedUntil) {
      await prisma.session.update({ where: { id: sessionId }, data: { isRevoked: true } });
...
app.route("/booking-engine", booking_engine_default);
app.route("/villas", refund_policy_default);
var src_default = {
  fetch: app.fetch,

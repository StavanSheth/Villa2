...
// .wrangler/tmp/bundle-ASarC0/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-ASarC0/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-ASarC0/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
      ...
      if (booking) {
        ...
        await prisma.$transaction(async (tx) => {
          ...
          await tx.booking.update({
            ...
            data: {
              status: "CONFIRMED",
              paidAmount: { increment: paymentEntity.amount / 100 }
            }
          });
        }, {
        ...
        invoice = await prisma.$transaction(async (tx) => {
          ...
          const newInvoice = await tx.invoice.create({
            data: {
              ...
              taxAmount: Number(booking.totalAmount) * 0.18,
              // 18% GST example
              totalAmount: Number(booking.totalAmount) * 1.18,
              items: {
                create: [
                  {

...
import { auth } from '@villa-platform/hooks';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="max-w-md w-full bg-card border border-border shadow-xl rounded-xl p-8">
        ...
        <p className="text-sm text-muted-foreground text-center mb-4">Sign in to access daily tasks and operations</p>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input 
              ...
              placeholder="staff@mavon.online"
              required
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full py-3 bg-primary text-primary-foreground font-semibold rounded hover:brightness-110 transition-colors mt-6 shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          >

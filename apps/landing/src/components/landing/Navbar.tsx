        ...
        <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-2.5">
            {NAV_LINKS.map((link, idx) => {
              const isDashboard = (link.label as string) === 'Dashboard';
              return (
                <motion.a
                  key={link.label}
                  href={link.href}
                  ...
                  className={`pointer-events-auto px-4 py-2 rounded-full text-xs font-medium tracking-wider uppercase transition-all duration-300 shadow-md ${
                    isDashboard
                      ? 'bg-gold/20 border border-gold text-gold hover:bg-gold hover:text-black font-semibold shadow-[0_4px_15px_rgba(212,175,55,0.3)]'
                      : isDark
                  ...
                  return (
                    <a
                      ...
                      className={`group flex items-center justify-between font-serif text-lg sm:text-xl py-3 px-4 rounded-2xl transition-all ${
                        isDashboard
                          ? 'bg-gold/15 text-gold border border-gold/40 hover:bg-gold hover:text-black font-semibold'
                          : isDark

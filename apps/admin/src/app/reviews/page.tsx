...
export default async function AdminReviewsPage() {
  ...
  return (
    <div className="animate-fade-in space-y-8">
      <div>
        <h1 className="text-2xl font-serif text-[#D4AF37]">Review Moderation</h1>
        ...
        <div className="space-y-4">
          {reviews.map((review: any) => (
            <div key={review.id} className="bg-white/5 border border-white/10 rounded-xl p-6">
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-6 italic border-l-2 border-[#D4AF37]/50 pl-4">
                "{review.comment}"
              </p>
              ...
              <div className="flex justify-between items-center pt-4 border-t border-white/10">
                ...
                <div className="flex gap-3">
                  ...
                  <button className="text-xs px-4 py-2 bg-[#D4AF37] text-black rounded font-medium hover:bg-[#D4AF37]/90 transition-colors">
                    Approve
                  </button>
                </div>
              </div>

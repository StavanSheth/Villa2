  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {villas.map((villa) => (
          <div key={villa.id} className="bg-black/60 border border-white/10 rounded-xl overflow-hidden hover:border-[#D4AF37]/50 transition group">
            ...
            <div className="p-5 space-y-3">
              <div className="flex justify-between items-start">
                <div>
                  <h2 className="text-lg font-medium text-white group-hover:text-[#D4AF37] transition">{villa.name}</h2>
              ...
              <div className="pt-3 border-t border-white/10 flex justify-between items-center text-xs">
                ...
                <div>
                  ...
                  <span className="text-[#D4AF37] font-semibold">{villa.occupancy}</span>
                </div>
              </div>
              ...
              <div className="pt-2 flex items-center justify-end gap-2">
                ...
                <button className="p-2 text-white/50 hover:text-[#D4AF37] hover:bg-white/10 rounded-lg transition" title="Edit Villa">

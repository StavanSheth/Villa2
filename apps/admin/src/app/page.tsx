        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {adminLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="card group hover:border-[#D4AF37]/40 transition-all"
            >
              <div className="text-white/40 group-hover:text-[#D4AF37] transition-colors mb-3">
                {link.icon}
              </div>
              ...
              <ArrowRight className="w-3.5 h-3.5 text-white/20 group-hover:text-[#D4AF37] mt-3 transition-colors" />
            </Link>
          ))}
        </div>
      </div>

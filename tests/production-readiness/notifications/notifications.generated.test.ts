...
const myScenarios = parsed.scenarios.filter((s: any) => s.category === 'notifications' && s.actor.includes('system_generator'));

if (myScenarios.length > 0) {
  describe('Generated Permutations: NOTIFICATIONS', () => {

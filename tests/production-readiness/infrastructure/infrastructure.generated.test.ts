...
const myScenarios = parsed.scenarios.filter((s: any) => s.category === 'infrastructure' && s.actor.includes('system_generator'));

if (myScenarios.length > 0) {
  describe('Generated Permutations: INFRASTRUCTURE', () => {
